...
import {ObjectCheckCallback, ObjectContent} from '../../typings';
import getObjectKeysAndValues from '../../utils/getObjectKeysAndValues';
import {checkForNothing, nothing} from './nothing';

export default
function findInObjectCollectionHelper(collection: ObjectContent<any>, callback: ObjectCheckCallback<any>): Observable<any> {
